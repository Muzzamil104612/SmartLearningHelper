...
const StudentsDetail = ({ route, navigation }) => {
    ...
    const handleAccept = async () => {
        try {
          ...
          await firebase.firestore().collection('requests')
            .where('parentEmail', '==', student.studentDetails.parentEmail)
            .where('studentEmail', '==', student.studentDetails.email)
            .where('majorSubject', '==', myObject.majorSubject)
            .where('teacherEmail', '==', myObject.email)
            .get()
            .then(querySnapshot => {
              querySnapshot.forEach(async doc => {
                await firebase.firestore().collection('requests').doc(doc.id).update({
                  status: 'Accepted',
                });
              });
            });
          ...
          const groupData = {
            parentEmail: student.studentDetails.parentEmail,
            studentEmail: student.studentDetails.email,
            teacherEmail: myObject.email,
            groupName: groupName,
                ...
                <SafeAreaView style={styles.container1}>
                    ...
                    <Animatable.View animation="fadeInUpBig" duration={1000} style={styles.imgview}>
                        ...
                        <View style={styles.circle}>
                            <TouchableOpacity >
                                {student.studentDetails.ImageURL ? (
                                    <Image source={{ uri: student.studentDetails.ImageURL }} style={styles.selectedImage} />
                                ) : (
                ...
                >
                    <View style={styles.formview}>
                        ...
                        <TextInputComponent
                            ...
                            value={student.studentDetails.name}
                        ...
                        <TextInputComponent
                            ...
                            label="Email Address"
                            value={student.studentDetails.email}
                        ...
                        />
                          <TextInputComponent
                            ...
                            value={student.studentDetails.parentEmail}
                            placeholder="john23@gmail.com"
                            secureTextEntry={false}
                            keyboardType="default"
                            editable={false}
                        />
                          <TextInputComponent
                            onChangeText={Text => setMyObject({ ...myObject, email: (Text) })}
                            label="Phone"
                            value={student.studentDetails.phone}
    ...
    disabled={acceptLoading} // Disable the button while loading
  >
...
<Modal visible={isModalVisible} transparent animationType="slide">
            <View style={styles.modalContainer}>
              <View style={styles.modalContent}>
                ...
                />
                <TouchableOpacity style={styles.acceptButton} onPress={handleAccept}   disabled={acceptLoading} // Disable the button while loading
  >
 {acceptLoading ? (
