...
const TeacherSetting = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={{}}>
        <OptionBar navigation={navigation} DisplayText='Edit Your Teacher Profile' IconName='user-check'  ></OptionBar>
