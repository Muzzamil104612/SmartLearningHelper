...
const PaymentByTeacher = ({ navigation }) => {
    ...
    const viewDetails = (teacher) => {
        ...
        navigation.navigate('SpecificTeacherPayment', { teacher });
      };
...
const styles = StyleSheet.create({
    ...
    loadingIndicator: {
        marginTop: hp(19), // Adjust the marginTop as needed
      },
...
export default PaymentByTeacher;
