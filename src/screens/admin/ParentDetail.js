...
const ParentDetail = ({ route, navigation }) => {
            ...
            < View >
                <SafeAreaView style={styles.container1}>
                    ...
                    <Animatable.View animation="fadeInUpBig" duration={1000} style={styles.imgview}>
                        ...
                        <View style={styles.circle}>
                            <TouchableOpacity >
                                {parent.ImageURL ? (
                                    <Image source={{ uri: parent.ImageURL }} style={styles.selectedImage} />
                                ) : (
                ...
                >
                    ...
                    <TouchableOpacity onPress={async () => {
                        const studentSnapshot = await firebase.firestore().collection('Students').where('parentEmail', '==', parent.email).get();

                        if (!studentSnapshot.empty) {
                            Alert.alert(
                                'Cannot Delete Parent',
                                'This parent is associated with one or more students. You cannot delete a parent linked to students.'
                            );
                        } else {
                            Alert.alert(
                                'Confirm Delete',
                                    ...
                                    },
                                    {
                                        ...
                                        onPress: async () => {
                                            try {
                                                ...
                                                await firebase.firestore().collection('Parents').doc(parent.userID).delete();
