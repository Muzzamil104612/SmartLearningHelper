...
const HomeScreenForStudent=()=> {
  ...
  component={StudentHomePage}
      ...
      />
       ...
       <Tab.Screen      name="StudentSetting"
          component={StudentSetting}  options={{ headerShown: false,
        tabBarIcon: ({ color, size }) => (
      ...
      <Tab.Screen
         name="StudentSearch" component={ StudentSearch}
        options={{
          headerShown: false,
          tabBarIcon: ({ color }) => (
 ...
 export default HomeScreenForStudent;