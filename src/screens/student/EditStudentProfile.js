...
const EditStudentProfile = ({ navigation }) => {
    ...
    const [myObject, setMyObject] = useState({
        userID: '', name: '', email: '', phone: '', parentEmail: '',
    ...
    const [myObject1, setMyObject1] = useState({
        emailError: '', nameError: '', PhoneError: '', imageError: '', pemailerror: '',
    });
            ...
            if (myObject.ImageURL !== data.ImageURL) {
                ...
                await imageRef.putFile(myObject.ImageURL)
                    ...
                    .then(async (downloadURL) => {
                        ...
                        setIsLoading(false);
                        navigation.navigate('StudentSetting');
                        ...
                        >
                            <View style={styles.formview}>
                                ...
                                <TextInputComponent
                                    ...
                                    keyboardType="default"
                                />
                                {myObject1.pemailerror !== '' && <Text style={{ height: hp(3), color: 'red', marginLeft: wp(2), }}>{myObject1.pemailerror}</Text>}
